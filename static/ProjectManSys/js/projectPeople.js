//tab标识当前页
$('#projectPeopleLnk').addClass('active');
...
$(document).ready(function() {
	...
	$('#projectPeople').datagrid({
	    ...
	    columns:[[ 
	        ...
	        {field:'sex',title:'Sex',sortable:true,formatter:onPeopleSex,width:($(window).width() - sidebarWidth) * 0.1}, 
	        {field:'phone',title:'Tel',sortable:true,width:($(window).width() - sidebarWidth) * 0.1}, 
	        {field:'email',title:'Email',sortable:true,width:($(window).width() - sidebarWidth) * 0.1}, 
	        {field:'department',title:'Department',sortable:true,width:($(window).width() - sidebarWidth) * 0.2,
	        	editor:{
	        		type:'combotree',
	        		options:{ 
	        			valueField:'id',
	        			...
	        			panelHeight:158,
	        			method:'get',
	        			url:'/BaseSys/departmentRead',
	        		}
	        	}},
	        {field:'position',title:'Position',sortable:true,editor:'text',width:($(window).width() - sidebarWidth) * 0.2,
				editor:{
	        		type:'combobox',
	        		options:{ 
	        			valueField:'id',
