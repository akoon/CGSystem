...
Ext.define('Extensible.App', {
    ...
    constructor : function() {
        ...
        this.calendarStore = Ext.create('Extensible.calendar.data.MemoryCalendarStore', {
        	...
        	proxy: {
				type: 'ajax',
				url: '/TimeSheetSys/getScheduleStatus',
				reader: {
						type: 'json',
						root: 'status',
        ...
        */
        this.eventStore = Ext.create('Extensible.calendar.data.MemoryEventStore', {
		    ...
		    proxy: {
		        type: 'ajax',
		        api: {
					read: '/TimeSheetSys/getScheduleTasks/' + Ext.get("user-id").dom.innerHTML,
					create: '/TimeSheetSys/addScheduleTasks/' + Ext.get("user-id").dom.innerHTML,
					update: '/TimeSheetSys/UpdateScheduleTasks/' + Ext.get("user-id").dom.innerHTML,
					destroy: '/TimeSheetSys/RemoveScheduleTasks/' + Ext.get("user-id").dom.innerHTML
				},
		        noCache: false,
		        successProperty: 'success',
		        reader: {
