...
Extensible.Config = {
    ...
    writeIncludes: function() {
        ...
        me.includeStylesheet(me.extJsRoot + 'resources/css/ext-ie.css');
        ...
        //Extensions
        me.includeStylesheet(me.extJsRoot + 'BoxSelect.css');
        me.includeScript(me.extJsRoot + 'BoxSelect.js');
