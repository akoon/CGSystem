...
Ext.define('Ext.calendar.form.EventWindow', {
    ...
    constructor: function(config) {
        var formPanelCfg = {
            ...
            /*{
            	xtype: 'taskcombo',
                itemId: 'mission_combobox',
                name: 'missionComboBox',
                anchor: '100%',
                fieldLabel: 'Mission',
                //store: this.tasklistStore
            },*/
        ...
        /*
        //任务列表
        if (config.tasklistStore) {
            this.tasklistStore = config.tasklistStore;
            delete config.tasklistStore;
