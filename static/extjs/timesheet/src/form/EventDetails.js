...
Ext.define('Ext.calendar.form.EventDetails', {
    ...
    requires: [
        ...
        'Ext.calendar.form.field.TaskCombo'
    ],
    ...
    initComponent: function() {
        ...
        // 任务列表
        this.taskField = new Ext.calendar.form.field.TaskCombo({
        	fieldLabel: 'Task',
            name: 'Task',
            anchor: '70%'
        });
        ...
        var leftFields = [this.titleField, this.dateRangeField, this.taskField, this.reminderField],
