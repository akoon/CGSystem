...
Ext.define('Ext.calendar.App', {
    ...
    constructor : function() {
        ...
        console.log('Login username='+this.usrname+', userid='+ this.usrid);
        
        //********Task List Store********
		this.tasklistStore = Ext.create('Ext.calendar.data.TaskListStore');
        ...
        this.eventStore = Ext.create('Ext.calendar.data.MemoryEventStore', {
		    ...
		    proxy: {
		        type: 'ajax',
		        api: {
					read: '/get_actual_tasks',
					update: '/update_actual_task'
				},
		        noCache: false,
